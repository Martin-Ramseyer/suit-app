                ...
                <div class="p-6 bg-white border-b border-gray-200">
                    ...
                    <form action="{{ route('usuarios.update', $usuario->id) }}" method="POST">
                        ...
                        <div>
                            ...
                            <x-text-input id="nombre_completo" class="block mt-1 w-full" type="text" name="nombre_completo" :value="old('nombre_completo', $usuario->nombre_completo)" required autofocus />
                        </div>

                        <!-- Usuario -->
                        <div class="mt-4">
                            <x-input-label for="usuario" :value="__('Usuario')" />
                            <x-text-input id="usuario" class="block mt-1 w-full" type="text" name="usuario" :value="old('usuario', $usuario->usuario)" required />
                        </div>

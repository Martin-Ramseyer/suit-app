                        ...
                        <div class="mb-4">
                            <div class="flex items-center space-x-4">
                                <div class="flex-grow">
                                    ...
                                    <x-text-input type="text" id="search-input" name="search" class="w-full"
                        ...
                        <div class="mb-4">
                            <form id="evento-filter-form" action="{{ route('invitados.index') }}" method="GET"
                                ...
                                <div class="flex-grow">
                                    ...
                                    <select name="evento_id" id="evento-select-rol"
                                        class="w-full rounded-md shadow-sm border-gray-300"
                    ...
                    @else
                        ...
                        @if ($eventoSeleccionado)
                            <div class="mb-4 p-4 bg-blue-50 border border-blue-200 text-blue-800 rounded-md">
                                <p class="font-bold">Mostrando invitados para el evento del
                                    <strong>{{ \Carbon\Carbon::parse($eventoSeleccionado->fecha_evento)->format('d/m/Y') }}</strong>
                                </p>
                            ...
                            <div class="mb-4">
                                <form id="cajero-search-form" action="{{ route('invitados.index') }}" method="GET">
                                    ...
                                    <x-text-input type="text" id="search-input-cajero" name="search" class="w-full"
                                        :value="request('search')" placeholder="Escribe un nombre para filtrar..." />
                                </form>
                            </div>
                        @else
        ...
        <script>
            document.addEventListener('DOMContentLoaded', function() {
                ...
                function fetchInvitados(searchQuery, eventoId) {
                    const url =
                        `{{ route('invitados.index') }}?search=${encodeURIComponent(searchQuery)}&evento_id=${encodeURIComponent(eventoId)}`;
                ...
                if (rrppSearchInput && rrppEventoForm && !
                    adminEventoSelect) { // Evita que se ejecute en la vista de Admin

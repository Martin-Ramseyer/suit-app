                ...
                <div class="p-6 bg-white border-b border-gray-200">
                    ...
                    <form action="{{ route('invitados.store') }}" method="POST">
                        ...
                        <div class="mt-4">
                            ...
                            <x-text-input id="numero_acompanantes" class="block mt-1 w-full" type="number" name="numero_acompanantes" :value="old('numero_acompanantes', 0)" required />
                        </div>

                        <!-- Evento -->
                        <div class="mt-4">
                            <x-input-label for="evento_id" :value="__('Seleccionar Evento')" />
                            <select name="evento_id" id="evento_id" class="block mt-1 w-full rounded-md shadow-sm border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50" required>
                        ...
                        <div class="mt-4">
                            ...
                            <div class="mt-2 space-y-2">
                                ...
                                <label class="inline-flex items-center">
                                    <input type="checkbox" name="beneficios[]" value="{{ $beneficio->id }}" class="rounded border-gray-300 text-indigo-600 shadow-sm focus:ring-indigo-500">

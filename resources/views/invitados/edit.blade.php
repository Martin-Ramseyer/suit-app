                ...
                <div class="p-6 bg-white border-b border-gray-200">
                    ...
                    <form action="{{ route('invitados.update', $invitado->id) }}" method="POST">
                        ...
                        <div class="mt-4">
                            ...
                            <x-text-input id="numero_acompanantes" class="block mt-1 w-full" type="number" name="numero_acompanantes" :value="old('numero_acompanantes', $invitado->numero_acompanantes)" required min="0" />
                        </div>
                            ...
                            <div class="space-y-3">
                                ...
                                @foreach($beneficios as $beneficio)
                                    @php
                                        ...
                                        $cantidad = $asignado ? $beneficiosAsignados[$beneficio->id]->pivot->cantidad : 1;
                                    @endphp
                                <div class="flex items-center space-x-4 p-2 rounded-lg hover:bg-gray-50">
                                    ...
                                    <input type="number" name="cantidades[{{ $beneficio->id }}]"
                                           ...
                                           min="1" value="{{ old("cantidades.{$beneficio->id}", $cantidad) }}">
                                </div>
                                @endforeach
                            </div>
                        </div>
                        ...
                        <div class="flex items-center justify-end mt-6 border-t border-gray-200 pt-4">
                            <a href="{{ route('invitados.index') }}" class="text-sm text-gray-600 hover:text-gray-900 underline">Cancelar</a>
